...
def thrust_to_pwm(thrust, voltage=14.8):
    ...
    pwm = (1 - weight) * sqrt_model(thrust, *COEFFS[low][thrust_sign]) + weight * sqrt_model(thrust, *COEFFS[high][thrust_sign])
...
if __name__ == "__main__":
    ...
    print(thrust_to_pwm(0, voltage=14))
    print(thrust_to_pwm(0, voltage=12))
    # TODO test thrust_to_pwm
