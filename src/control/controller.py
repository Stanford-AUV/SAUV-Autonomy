...
from control.utils import pose_to_np, vel_to_np, same_sgn, clamp
...
class PID:
    def __init__(self, 
        ...
        :param Kp: The value of the proportional gain
        :param Ki: The value of the integral gain 
        :param Kd: The value of the derivative gain
        :param ff: The value of the feed forward term (if there is one)
        :param time_fn: The function to use for getting the current time, or None by default. 
        :param max_output: The value to clamp the output to, or None by default.
        :start_i: The value of error to start the integral term
        """
    ...
    def reset(self):
        ...
        This sets each term to 0 as well as clearing the integral, the last ouput and the last input 
        """
        self.current = 0
        self.desired = 0
        self.derivative = 0
